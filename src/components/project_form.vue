...
const isProjecteEmpty = computed(
...
<template>
  <div class="form">
    ...
    <div class="field has-addons">
      <div class="control">
        <input
          @keypress.enter="addTag(currentTag)"
          v-model="currentTag"
          class="input is-info"
          type="text"
      ...
      <div class="control">
        <a @click="addTag(currentTag)" class="button is-info"> añadir </a>
      </div>
    </div>
